...
(function (PhaserInput) {
    ...
    var InputField = (function (_super) {
        ...
        function InputField(game, x, y, inputOptions) {
            ...
            _this.domElement = new PhaserInput.InputElement(_this.game, 'phaserinput-' + (Math.random() * 10000 | 0).toString(), _this.inputOptions.type, _this.value, _this.focusIn, _this.focusOut);
...
//# sourceMappingURL=phaserinput.js.map